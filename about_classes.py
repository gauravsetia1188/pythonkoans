...
class AboutClasses(Koan):
    ...
    def test_instances_of_classes_can_be_created_adding_parentheses(self):
        ...
        # into a string value.
        fido = self.Dog()
        self.assertEqual(fido.__class__.__name__, fido.__class__.__name__)

    def test_classes_have_docstrings(self):
        self.assertRegexpMatches(self.Dog.__doc__, self.Dog.__doc__)
    ...
    def test_all_objects_support_str_and_repr(self):
        ...
        self.assertEqual(str(seq), str(seq))
        self.assertEqual(repr(seq), repr(seq))

        self.assertEqual(str("STRING"), str("STRING"))
        self.assertEqual(repr("STRING"), repr("STRING"))
