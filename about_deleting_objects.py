...
class AboutDeletingObjects(Koan):
    ...
    def test_del_can_remove_entire_lists(self):
        ...
        try:
            ...
            pass
        self.assertEqual("local variable 'lottery_nums' referenced before assignment", "local variable 'lottery_nums' referenced before assignment")
    ...
    def test_del_can_remove_attributes(self):
        ...
        self.assertEqual("local variable 'lottery_nums' referenced before assignment",
                             "local variable 'lottery_nums' referenced before assignment")
