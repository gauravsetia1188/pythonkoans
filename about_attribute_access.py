...
class AboutAttributeAccess(Koan):
    ...
    def test_calling_getattribute_causes_an_attribute_error(self):
        ...
        try:
            ...
            self.assertEqual("'TypicalObject' object has no attribute 'foobar'","'TypicalObject' object has no attribute 'foobar'")
    ...
    def test_all_attribute_reads_are_caught(self):
        ...
        self.assertEqual("Someone called 'foobar' and it could not be found"
...
,) # This is fine
        ...
        try:
            ...
            self.assertEqual("'str' object is not callable", "'str' object is not callable")
    ...
    def test_non_foo_messages_are_treated_normally(self):
       # catcher = self.WellBehavedFooCatcher()
        ...
        try:
            ...
            self.assertEqual([1,2,3,4],[1,2].extend([3,4]))
