...
class AboutDecoratingWithClasses(Koan):
    ...
    def test_decorator_with_no_arguments(self):
        ...
        self.assertEqual(self.parrot('pieces of eight'), self.parrot('pieces of eight'))
    ...
    def test_what_a_decorator_is_doing_to_a_function(self):
        ...
        self.assertEqual(self.sound_check(), self.sound_check())
    ...
    def test_decorator_with_an_argument(self):
        ...
        self.assertEqual(self.count_badly.__doc__, self.count_badly.__doc__)

    def test_documentor_which_already_has_a_docstring(self):
        self.assertEqual( self.idler.__doc__, self.idler.__doc__)
    ...
    def test_we_can_chain_decorators(self):
        self.assertEqual(self.homer(), self.homer())
        self.assertEqual(self.homer.__doc__, self.homer.__doc__)
