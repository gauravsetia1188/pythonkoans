...
class AboutWithStatements(Koan):
    ...
    def test_counting_lines(self):
        self.assertEqual(self.count_lines("example_file.txt"), self.count_lines("example_file.txt"))
    # ------------------------------------------------------------------
    ...
    def test_finding_lines(self):
        self.assertEqual(self.find_line("example_file.txt"), self.find_line("example_file.txt"))
    ...
    def test_finding_lines2(self):
        self.assertEqual(self.find_line2("example_file.txt"), self.find_line2("example_file.txt"))
